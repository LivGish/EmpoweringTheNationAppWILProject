...
interface CookingScreenProps {
 ...
 goBack?: () => void;
  ...
  export default function CookingScreen({ setCurrentScreen, previousScreen, goBack }: CookingScreenProps) {
    const handleGoBack = () => {
        if (goBack) {
            goBack();
        } else {
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.container}>
           ...
           <Image
             source={require('../assets/images/courses/cooking.png')}
              style={styles.image}
              resizeMode="cover"
            />

            <Text style={styles.description}>Teaches students to prepare and cook nutritious family meals.</Text>
